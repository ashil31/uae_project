// src/components/cloths/ClothRollFormModal.jsx
...
const ClothRollFormModal = ({ isOpen, onClose, roll, onSaved }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!roll) {
        ...
        await dispatch(updateClothRoll({ id: roll._id || roll.rollId, data })).unwrap();
      ...
      const msg = (error && error.message) || "Failed to save cloth roll";
      toast.error(msg);
    } finally {
      setLoading(false);
    }
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <motion.div animate={{ rotate: unitOpen ? 180 : 0 }} transition={{ duration: 0.25 }} className="text-gray-500">
                        ...
                        >
                          {["meters", "kilos", "unit"].map((option) => (
                            <li
                              ...
                              className={`px-4 py-2 cursor-pointer transition-colors duration-150 ${formData.unitType === option ? "font-medium text-purple-700" : "text-gray-700"} hover:bg-purple-50 hover:text-purple-600`}
                            >
