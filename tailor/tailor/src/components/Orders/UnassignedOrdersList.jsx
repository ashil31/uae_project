    ...
    return (
      ...
      >
        ...
        <p className="text-gray-500 mt-1">
          Great job! There are no pending orders to assign.
        </p>
      </motion.div>
    );
  }
              ...
              return (
                <tr key={order._id + "_" + index}>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500">
                          Color: {product.color}, Size: {product.size}, Qty:{" "}
                          {product.quantity}
                        </div>
                      </div>
                    </div>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700">
                    <div>
                      Name:{" "}
                      <strong>{product.customization?.name || "N/A"}</strong>
                    </div>
                    <div>
                      Embroidery:{" "}
                      <strong>
                        {product.customization?.embroidery || "N/A"}
                      </strong>
                    </div>
                  </td>
